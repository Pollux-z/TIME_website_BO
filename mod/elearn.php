                        ...
                        <div class="padding" data-plugin="search" id="search-list">
                            <form action="#" class="mb-3">
                                <div class="input-group">
                                    ...
                                    $rs = mysqli_query($conn,"SELECT * FROM `db_elearn` WHERE `status` = 2$sq");
                                ...
                                <div class="col-sm-4">
                                    <div class="card">
                                        <div class="media media-2x1 gd-primary">
                                            <a class="media-content" href="?mod=km-edit&id=<?php echo $row['id'];?>" style="background-image:url(https://img.youtube.com/vi/<?php echo $row['vid'];?>/0.jpg)">
                                        ...
                                        <div class="card-body">
                                            <a href="?mod=elearn-edit&id=<?php echo $row['id'];?>" class="card-link">Watch</a>
