<div class="text-right mb-3"><a href="uploads/cover/TIME Cover Letter Design 2022.docx" target="_blank"><i class="mx-2" data-feather="download"></i>Download Template Timeconsulting</a></div>
<div class="text-right mb-3"><a href="uploads/cover/TIME Digital Cover Letter Design 2022.docx" target="_blank"><i class="mx-2" data-feather="download"></i>Download Template Time Digital</a></div>
<div class="text-right mb-3"><a href="uploads/cover/Disrupt Tech Cover Letter Design 2022.docx" target="_blank"><i class="mx-2" data-feather="download"></i>Download Template Disrupt Tech</a></div>
<?php
                                            ...
                                            while($row=mysqli_fetch_assoc($rs)){
                                                echo '<tr class=" " data-id="'.$row['id'].'">
                                                        <td style="text-align:center">
                                                            <small class="text-muted">TIME'.substr($row['date'],0,4).'/'.str_pad($row['code'], 5, 0, STR_PAD_LEFT).'</small>
                                                        </td>
                                                        <td>'.$row['date'].'
                                                        </td>
                                                        <td class="flex">
