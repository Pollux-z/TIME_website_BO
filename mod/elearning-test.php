<?php if(in_array('elearning-test',$edits)||$_SESSION['ses_ulevel']>7){?>
    <div class="mb-2 text-right">
    <a href="?mod=elearning-test">My E-Learning</a> | 
    <a href="?mod=elearning-test&page=summary">Summary</a> |
    <a href="?mod=elearning-test&page=VDO-test">VDO test</a>
</div>
<?php }?>
