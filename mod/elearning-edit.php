<?php if(in_array('elearning',$edits)||$_SESSION['ses_ulevel']>7){
    ...
    <div class="form-row">
        ...
        <label>ชื่อวิดีโอ</label>
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <textarea name="description" class="form-control" rows="7" placeholder=""><?php echo $description;?>
</textarea>
</div></div>
<div class="form-row">
        <div class="form-group col-sm-6">
        <label>YouTube ID</label>
                                                            <input type="text" class="form-control" name="v" value="<?php echo $v;?>" required>
