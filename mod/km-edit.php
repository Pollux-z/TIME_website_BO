<?php
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $rs = mysqli_query($conn,"SELECT * FROM `db_km` WHERE `id` = $id AND `status` != 0 ORDER BY `id` DESC");
                                    ...
                                    <form data-plugin="parsley" data-option="{}" action="action.php" method="POST" enctype="multipart/form-data">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <img src="uploads/km/<?php echo $row['id'];?>.png" alt="" class="img-fluid">
                                                    </div>
                                                    <div class="col-md-9">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control" name="location" value="<?php echo $location;?>"<?php if(isset($readonly)){echo $readonly;}?>>
                                                            </div>
                                                            <div class="form-group col-sm-12">
                                                                <label>Hashtag</label>
                                                            ...
                                                            <div class="form-group col-sm-12">
                                                                <label>Picture</label>
                                                                <input type="file" class="form-control" name="file"<?php if(isset($readonly)){echo $readonly;}?>><br>
                                                                <?php echo implode(',',$pixs);?>
                                                            </div>
<!--
                                                        <?php if(isset($id)){?>
                                                            <div class="form-group col-sm-12">
