            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <input type="hidden" name="mod" value="timeoff">
...
<div class="row row-sm">
    ...
    echo $left;
                ...
                <div class="progress my-3 circle" style="height:6px;">
                    <div class="progress-bar circle gd-success" data-toggle="tooltip" style="width: <?php echo ceil($left/$row['day']*100);?>%"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php if($_SESSION['ses_ulevel']>7){?>                                   
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Reason for leave</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">วันที่ลา</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <div class="checkbox">
                                                        <label class="ui-check mr-3">
                                                            <input type="checkbox" class="halfDay" name="half" value="am"<?php
                                                        ...
                                                        <label class="ui-check">
                                                            <input type="checkbox" class="halfDay" name="half" value="pm"<?php
                                                    ...
                                                    <small class="form-text text-muted">เลือกเฉพาะวันที่ต้องการจะลา ไม่รวมวันเสาร์อาทิตย์ และวันหยุดตาม<a href="uploads/announce/time2021-00008.pdf" target="_blank">ประกาศ SAMYAN Mitrtown</a></small>
                                                </div>
                                            </div>                                        
                                    </div>
                                    <div class="card-footer">
...
<script>
$('input.halfDay').on('change', function() {
    $('input.halfDay').not(this).prop('checked', false);  
});
</script>